...
export default component$(() => {
  return (
       <div class="relative bg-white/80 rounded-t-sm dark:bg-gray-900/80 overflow-hidden flex items-center justify-center mx-1 my-0.5 border-radius-dot-25 rounded-b-xl">
