...
export default component$((props: Props) => {
  ...
  return (
    <div class="relative bg-white/80 dark:bg-gray-900/80 overflow-hidden flex items-center justify-center mx-1.5 mt-1 mb-1.5 rounded-t-sm border-radius-dot-25 rounded-b-xl">
      <div class="relative max-w-4xl mx-1.5 my-1.5 lg:px-8">
        <div class="max-w-3xl mx-auto lg:mt-24 bg-white/95 dark:bg-slate-900/95 rounded-b-xl rounded-t-sm pt-6 p-3 border-radius-dot-25">
