...
export default component$((props: Props) => {
  ...
  return (
    <div class="relative bg-white/80 dark:bg-gray-900/80 overflow-hidden flex items-center justify-center mx-1 mt-1 mb-1.5 rounded-t-sm border-radius-dot-25 rounded-b-xl">
