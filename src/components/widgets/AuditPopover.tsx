...
export default component$(() => {
  return (
    <Popover.Root flip={false} gutter={8}>
      <Popover.Trigger >
      <a href="#" class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-6 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
